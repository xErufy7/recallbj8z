...
export const ROMANCE_EVENTS: GameEvent[] = [
        ...
        choices: [
            {
                text: '连忙道歉并帮TA捡起来',
                action: (s) => ({
                    general: { ...s.general, romance: s.general.romance + 5, charisma: s.general.charisma + 2 },
            ...
            {
                text: '假装镇定，酷酷地把书递给TA',
                condition: (s) => s.general.charisma > 40,
                action: (s) => ({
        ...
        choices: [
            {
                ...
                action: (s) => ({
                    general: { ...s.general, romance: s.general.romance + 8, charisma: s.general.charisma + 3 },
    ...
    },
    {
        ...
        choices: [
            ...
            {
                text: '撑开伞：“一起走吧，顺路。”',
                condition: (s) => s.general.charisma > 30,
                action: (s) => ({
    ...
    // --- 阶段3：关键突破 (好感度 >= 70) ---
    {
        ...
        title: '周末的邀约',
        description: '你在微信上犹豫了很久，周末想约TA去市图/咖啡厅自习。',
        type: 'positive',
        triggerType: 'RANDOM',
        ...
        choices: [
            {
                text: '抢先开口：“我喜欢你！”',
                action: (s) => ({
                    general: { ...s.general, romance: s.general.romance + 30, mindset: s.general.mindset + 20, charisma: s.general.charisma + 10 },
